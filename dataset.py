...
class GenImage(Dataset):
    def __init__(self, root_dir, transform=None, sample_size=None):
        self.transform = transform
        self.data = []
        self.fake_index = 1  # Index of 'fake' in ['real', 'fake']
        self.real_index = 0  # Index of 'real' in ['real', 'fake']
        ...
        if 'ai' in sub_folders and 'nature' in sub_folders:
            # This is the 'biggan' case
        ...
        # Randomly select sample_size elements from self.data if sample_size is defined
